...
namespace OnnxLibrary
{
    public static class ImagePreprocessor
    {
        ...
        // 為目標檢測預處理圖像，同時返回原始尺寸資訊
        public static (DenseTensor<float> tensor, int originalWidth, int originalHeight) PreprocessImageForDetection(string imagePath, int inputWidth = 640, int inputHeight = 640)
        {
            using (var mat = new Mat(imagePath))
            {
                int originalWidth = mat.Width;
